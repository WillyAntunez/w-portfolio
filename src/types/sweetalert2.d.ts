declare module 'sweetalert2/src/sweetalert2' {
    ...
    namespace Swal {
        ...
        function isValidParameter(
            paramName: string,
        ): paramName is keyof SweetAlertOptions;
    ...
    export type SweetAlertArrayOptions = readonly [
        string?,
        string?,
        SweetAlertIcon?,
    ];
    ...
    type SweetAlertInputValidator =
        | {
              ...
              inputValidator?: (
                  value: string,
              ) => SyncOrAsync<string | null | false | void>;
          }
        | {
              input: 'file';
              /**
    ...
    export type SweetAlertOptions = SweetAlertInputValidator & {
        ...
        inputOptions?: SyncOrAsync<
            ReadonlyMap<string, string> | Record<string, any>
        >;
